<template>
  <div class="qar-item-wechat-box">
    <div v-bind:class="{'qad-item-wechat':true}">
...
<style lang="less" scoped>
  ...
  .qad-item-wechat>.title>.red{
    color:red
  }
  .qad-item-wechat>.input{
    height:36px;
